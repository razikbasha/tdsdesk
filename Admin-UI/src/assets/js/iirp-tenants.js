...
var handleDataTableTenantsSetting = function() {
	"use strict";
    
    if ($('#data-table-tenants').length !== 0) {
        $('#data-table-tenants').DataTable({
            dom: 'lBfrtip',
            buttons: [
...
var TableManageCombineTenants = function () {
	"use strict";
    return {
        //main function
        init: function () {
